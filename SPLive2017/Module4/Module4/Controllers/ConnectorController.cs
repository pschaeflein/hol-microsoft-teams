...
namespace Module4.Controllers
{
	public class ConnectorController : ApiController
	{
		...
		public async Task<HttpResponseMessage> Landing()
		{
			...
			htmlBody += "<a href='https://outlook.office.com/connectors/Connect?state=myAppsState&app_id=b25c1dcc-679e-4f92-aa45-af724904c67a&callback_url=https://466dab5d.ngrok.io/api/connector/redirect'>";
